	...
	return (
		<div className="mt-10 m-auto w-96 border-2">
			...
			<div className="flex flex-col items-center">
				...
				<button onClick={signInWithGoogle} className="px-4 py-2 mt-4 flex gap-2  items-center justify-center text-14 rounded-sm border border-black">
					{" "}
					<img src={googleLogo} alt="google logo" className="w-6" /> Sign in With Google
				</button>
			</div>
			{/* ------------- */}
			<div>
			...
			<div className="mt-10 flex flex-col gap-4">
				<button onClick={userSignInAction} className="mt-2 flex gap-2 p-2 items-center justify-center rounded-sm border bg-blue-500 text-white">
					Log in
				</button>
