...
function MobileHeader() {
	...
	return (
		<>
			...
			<div className={`opacity-90 z-50 absolute top-0 p-4 h-screen w-5/6  ${toggleMobileMenu ? "-translate-x-full transition ease-out duration-300" : "translate-x-0 transition ease-out duration-300	bg-pink-800"}`}>
